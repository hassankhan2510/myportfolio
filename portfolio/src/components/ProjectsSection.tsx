...
export default function ProjectsSection() {
    const softwareProjects = projects.filter(p => p.category === 'Enterprise AI Systems' || p.category === 'Full Stack Apps');

    return (
        <section id="projects" className="py-32 px-6">
            <div className="max-w-6xl mx-auto">
                <div className="mb-20">
                    <span className="text-sm font-mono text-theme-accent-purple tracking-wider flex items-center gap-2">
                        <Code2 className="w-4 h-4" /> 04. ENGINEERING
                    </span>
                                    ...
                                    <div className="relative z-10 flex flex-col h-full space-y-6">
                                        <div className="flex justify-between items-start">
                                            <div className="space-y-1">
                                                ...
                                                <h3 className="text-2xl font-display font-medium text-white group-hover:text-theme-accent-purple transition-colors">{project.title}</h3>
                                            </div>
